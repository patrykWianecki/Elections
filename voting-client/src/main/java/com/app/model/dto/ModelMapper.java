...
public interface ModelMapper {
    ...
    static TokenDto fromTokenToTokenDto(Token token) {
        return token == null ? null : TokenDto.builder()
            .id(token.getId())
            .voterToken(token.getVoterToken())
            .voterDto(token.getVoter() == null ? null : fromVoterToVoterDto(token.getVoter()))
            .build();
    }

    static Token fromTokenDtoToToken(TokenDto tokenDto) {
        return tokenDto == null ? null : Token.builder()
            .id(tokenDto.getId())
            .voterToken(tokenDto.getVoterToken())
